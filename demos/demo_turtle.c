...
static void draw_turtle_func(SDL_Surface *screen, int x, int y, void *userdata)
{
    ...
    esgx_draw_circle_raw(screen, x + 24, y + 24, 20, 34, 139, 34, 1);
    esgx_draw_circle_raw(screen, x + 24, y + 24, 18, 0,  180, 0,  1);

    esgx_draw_circle_raw(screen, x + 24, y + 4, 8, 34, 139, 34, 1);

    esgx_draw_circle_raw(screen, x + 4,  y + 12, 6, 34, 139, 34, 1);
    esgx_draw_circle_raw(screen, x + 44, y + 12, 6, 34, 139, 34, 1);
    esgx_draw_circle_raw(screen, x + 4,  y + 36, 6, 34, 139, 34, 1);
    esgx_draw_circle_raw(screen, x + 44, y + 36, 6, 34, 139, 34, 1);
...
int main(int argc, char *argv[])
{
    ...
    while (esgx_event_poll(&ev)) {
        double target_x = ev.mouse_x - 24.0;
